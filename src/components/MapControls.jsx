  ...
  return (
    <div style={{display:'flex',flexDirection:'column',gap:'8px'}}>
      ...
      <div style={{fontSize:'8px',color:'#475569',lineHeight:1.65,paddingTop:2,borderTop:'1px solid #1e2d47',marginTop:2}}>
        ...
        <div style={{color:'#fb923c',marginBottom:1}}>🟠 <b>CUP</b> — Escondido · El Cajon · Carlsbad · Oceanside · San Marcos · Santee · Nat City · La Mesa · Poway · Lemon Grove · Encinitas</div>
